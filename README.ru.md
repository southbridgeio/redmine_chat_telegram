...
Плагие не записывает сообщения чата в архив когда он остановлен. Во избежание потери сообщений плагин выполяет синхноризацию сообщений чата и архива при следующем запуске с задержкой в 5 минут.
