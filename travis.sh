...
git clone -b tdlib git://github.com/centosadmin/redmine_telegram_common.git $PATH_TO_REDMINE/plugins/redmine_telegram_common
...
bundle exec rake redmine:plugins:test NAME=$NAME_OF_PLUGIN --trace
